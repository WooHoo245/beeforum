...
return [
    ...
    */
    ...
    //'headline_logo' => '/vendor/devdojo/chatter/assets/images/banner_bg.png',
    ...
    */
    ...
    'user' => [
        ...
        'relative_url_to_profile'       => '/profile/{profile}',
        'relative_url_to_image_assets'  => '/uploads/avatars/default.jpg',
        'avatar_image_database_field'   => '{{user->avatar}}',
    ],
    ...
    */
    ...
    'tinymce' => [
        'toolbar' => 'bold italic underline | link image | imagetools | media | insertdatetime | emoticons | code | wordcount | fullscreen | autolink',
        'plugins' => 'link, image, imagetools, media, insertdatetime, emoticons, code, wordcount, fullscreen, autolink',
    ],
